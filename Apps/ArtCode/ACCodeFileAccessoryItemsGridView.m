//
//  ACCodeFileAccessoryItemsGridView.m
//  ArtCode
//
...
@implementation ACCodeFileAccessoryItemsGridView {
...
- (void)setAccessoryActions:(NSArray *)value
{
    ...
    if ([accessoryActions count] > 0)
    {
        ...
        [accessoryActions enumerateObjectsUsingBlock:^(ACCodeFileAccessoryAction *action, NSUInteger actionIndex, BOOL *stop) {
            UIButton *button = nil;
