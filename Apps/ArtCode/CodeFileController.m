...
- (id)init {
  ...
  [[[RACSubscribable combineLatest:@[RACAble(self.codeView.selectionRange), [RACAble(self.textFile.stringContent) switch]]] throttle:0.3] subscribeNext:^(RACTuple *tuple) {
    @strongify(self);
    if (!self) {
      return;
    }
