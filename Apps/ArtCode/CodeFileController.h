...
@interface CodeFileController : UIViewController <CodeFileMinimapViewDelegate, CodeViewDataSource, CodeViewDelegate, ACProjectFilePresenter, UIActionSheetDelegate, UIWebViewDelegate, TMKeyboardActionTarget>
