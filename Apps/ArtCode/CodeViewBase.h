...
typedef void (^CodeViewBaseTileSetupBlock)(CGContextRef context, CGRect rect);

@interface CodeViewBase : UIScrollView <TextRendererDelegate>
...
@interface CodeViewBase (TextRendererForwarding)
...
@property (nonatomic, strong) id<TextRendererDataSource> dataSource;
