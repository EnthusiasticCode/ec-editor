...
typedef enum {
    FileBufferAttributesChangeSet,
    FileBufferAttributesChangeAdd,
    FileBufferAttributesChangeRemove,
} FileBufferAttributesChange;

@protocol FileBufferConsumer <NSObject>
...
@optional
- (void)accommodateFileDeletionForFileBuffer:(FileBuffer *)fileBuffer;
- (void)fileBuffer:(FileBuffer *)fileBuffer fileDidMoveToURL:(NSURL *)dstURL;
...
- (void)fileBuffer:(FileBuffer *)fileBuffer willReplaceCharactersInRange:(NSRange)range withString:(NSString *)string;
- (void)fileBuffer:(FileBuffer *)fileBuffer didReplaceCharactersInRange:(NSRange)range withString:(NSString *)string;
- (void)fileBuffer:(FileBuffer *)fileBuffer willReplaceCharactersInRange:(NSRange)range withAttributedString:(NSAttributedString *)string;
...
- (void)fileBuffer:(FileBuffer *)fileBuffer willAddAttributes:(NSDictionary *)attributes range:(NSRange)range;
- (void)fileBuffer:(FileBuffer *)fileBuffer didAddAttributes:(NSDictionary *)attributes range:(NSRange)range;
- (void)fileBuffer:(FileBuffer *)fileBuffer willRemoveAttributes:(NSArray *)attributes range:(NSRange)range;
- (void)fileBuffer:(FileBuffer *)fileBuffer didRemoveAttributes:(NSArray *)attributes range:(NSRange)range;
...
@interface FileBuffer : NSObject <NSFilePresenter>
