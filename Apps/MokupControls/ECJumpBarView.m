...
- (void)setDelegate:(id<ECJumpBarViewDelegate>)aDelegate
{
    delegate = aDelegate;
...
static void init(ECJumpBarView *self)
{
...
- (void)layoutSubviews
{
    ...
    if (buttonSize.width < minimumStackButtonWidth)
        buttonSize.width = minimumSearchFieldWidth;
