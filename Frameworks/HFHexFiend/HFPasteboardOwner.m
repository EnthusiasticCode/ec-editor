...
//	UIEvent *event = [UIEvent otherEventWithType:NSApplicationDefined location:NSZeroPoint modifierFlags:0 timestamp:0 windowNumber:0 context:NULL subtype:0 data1:0 data2:0];
...
- (BOOL)moveDataWithProgressReportingToPasteboard:(UIPasteboard *)pboard forType:(NSString *)type {
...
- (void)pasteboard:(UIPasteboard *)pboard provideDataForType:(NSString *)type {
    if (! pasteboard) {
