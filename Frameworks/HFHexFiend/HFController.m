...
- (id)init {
    ...
    [self setFont:[UIFont fontWithName:@"Monaco" size:10.f]];
    return self;
}
...
- (void)beginSelectionWithEvent:(UIEvent *)event forByteIndex:(unsigned long long)characterIndex {
    USE(event);
...
- (void)continueSelectionWithEvent:(UIEvent *)event forByteIndex:(unsigned long long)characterIndex {
    USE(event);
...
- (void)endSelectionWithEvent:(UIEvent *)event forByteIndex:(unsigned long long)characterIndex {
    USE(event);
    HFASSERT(_hfflags.selectionInProgress);
    HFASSERT(characterIndex <= [self contentsLength]);
    if (_hfflags.commandExtendSelection) {
...
- (void)scrollWithScrollEvent:(UIEvent *)scrollEvent {
