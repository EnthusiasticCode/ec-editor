...
/// Returns a number in range [0.0, 1.0[ depending on how well the code index implements a given protocol for a given scope, in a given language, in a given file
...
/// In subclasses return 0.0 if the protocol is not implemented. Never return 1.0.
