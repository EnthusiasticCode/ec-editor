...
enum {
    ECKeyboardAccessoryPositionPortrait,
    ECKeyboardAccessoryPositionLandscape,
    ECKeyboardAccessoryPositionFloating
};
typedef NSInteger ECKeyboardAccessoryPosition;


@interface ECKeyboardAccessoryView : UIView
